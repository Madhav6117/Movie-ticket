...
def book():
    ...
    while choice.lower()=="y":
        ...
        if choice.lower()=='y':
            ...
            pass
        print("./n./n./n lets now proceed to billing...")
        ...
        with open(f'mticket_{no}.txt','w',encoding="utf-8") as billt:
            billt.write(billp)
            billt.close()
            print(f"bill is saved in your system as bill_{no}.txt")
        choice=""
def setname():
    tname=input("enter shop name:")
    print(f"theater name has been set to {tname}")
